...
func (this *OpServiceProxy) Dispatch( msg *rpc.RpcMsg ) error {
	...
	case 2:
		...
		_n_1_map:=proto.ReadInt32()
		for _i_1_:=0; int32(_i_1_)<_n_1_map; _i_1_++ {
			var tmpKey int32
		...
		var ai []int32
		_n_3_array:=proto.ReadInt32()
		for _i_3_:=0; int32(_i_3_)<_n_3_array; _i_3_++ {
			var tmp int32
			tmp=proto.ReadInt32()
			ai= append(ai,tmp)
		}
		...
		var ar []Role
		_n_4_array:=proto.ReadInt32()
		for _i_4_:=0; int32(_i_4_)<_n_4_array; _i_4_++ {
			var tmp Role
